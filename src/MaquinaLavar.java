...
public class MaquinaLavar extends Entity{
   ...
   */      
   ...
   public void lavar(Cliente cliente) {
	   ...
	   modeloLavanderia.qtdDeUsoMaquinaDeLavar.update();
	   modeloLavanderia.tempoTotalDeUsoMaquinaDeLavar.update((long) tempoLavagem);
	   modeloLavanderia.throughputDaLavanderia.update((long) tempoLavagem);
   }
