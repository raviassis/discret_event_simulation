...
public class EventoTerminoLavagem extends EventOf2Entities<MaquinaLavar, Cliente> {
	...
	public void eventRoutine(MaquinaLavar maquinaLavar, Cliente cliente) {
		...
		double tempoDoClienteNaLavanderia = modeloLavanderia.presentTime().getTimeAsDouble() - cliente.getInicioTempoResposta().getTimeAsDouble();
		modeloLavanderia.tempoMedioClienteNaLavanderia.update(tempoDoClienteNaLavanderia);
