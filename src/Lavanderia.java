...
public class Lavanderia extends Model{
	...
	/**
	 * qtdDeUsoMaquinaDeLavar: contagem de quantas vezes a máquina foi utilizada
	 */
	protected Count qtdDeUsoMaquinaDeLavar;

	/**
	 * tempoTotalDeUsoMaquinaDeLavar: tempo total de uso da maquina de lavar
	 */
	protected Count tempoTotalDeUsoMaquinaDeLavar;

	protected Tally tempoMedioClienteNaLavanderia;

	protected Tally throughputDaLavanderia;
	...
	public void init() {
		...
		/**
		 * Criação da contagem de uso da máquina de lavar roupas
		 * Parâmetros:
		 * Modelo ao qual a contagem está associada.
		 * Nome da contagem.
		 * Flag booleano que indica se a contagem deve ou não produzir saídas para um relatório da simulação.
		 * Flag que indica se a contagem deve ou não produzir saídas para um trace de saída.
		 */
		this.qtdDeUsoMaquinaDeLavar = new Count(this, "utilização da máquina de lavar-roupas", true, false);

		/**
		 * Criação da contagem do tempo de uso da máquina de lavar roupas
		 * Parâmetros:
		 * Modelo ao qual a contagem está associada.
		 * Nome da contagem.
		 * Flag booleano que indica se a contagem deve ou não produzir saídas para um relatório da simulação.
		 * Flag que indica se a contagem deve ou não produzir saídas para um trace de saída.
		 */
		this.tempoTotalDeUsoMaquinaDeLavar = new Count(this, "tempo total de utilização da máquina de lavar-roupas", true, false);

		this.tempoMedioClienteNaLavanderia = new Tally(this, "Tempo médio do cliente na lavanderia", true, false);

		this.throughputDaLavanderia = new Tally(this, "Throughput da lavanderia", true, false);
